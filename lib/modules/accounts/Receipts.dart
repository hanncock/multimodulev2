...
class Receipting extends StatefulWidget {
  const Receipting({super.key});

  @override
  State<Receipting> createState() => _ReceiptingState();
}

class _ReceiptingState extends State<Receipting>{
  ...
  getReceipting()async{
    var resu = await auth.getvalues("api/finance/paymentsetup/list");
